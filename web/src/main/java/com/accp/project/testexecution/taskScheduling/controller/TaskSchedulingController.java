package com.accp.project.testexecution.taskScheduling.controller;
...
import com.accp.common.constant.JobConstants;
...
import com.accp.common.utils.file.FileUploadUtils;
...
import com.accp.project.monitor.job.util.CronUtils;
	...
	public AjaxResult uploadJar(@RequestParam("drivenfile") MultipartFile file, @RequestParam("clientIp") String clientIp,@RequestParam("driverPath") String driverPath) {
		...
		try {
			if (!file.isEmpty()) {
				...
				File jarFile = FileUploadUtils.uploadJar(AppConfig.getUploadPath(), file);

...
public class UserConstants
{
    ...
    /** 班级正常状态 */
    public static final String CLAZZ_NORMAL = "0";
    /** 学生正常状态 */
    public static final String STUDENT_NORMAL = "0";
    ...
    /** 班级名称是否唯一的返回结果码 */
    public final static String CLAZZ_NAME_UNIQUE = "0";
    public final static String CLAZZ_NAME_NOT_UNIQUE = "1";
    

    /** 学号是否唯一的返回结果码 */
    public final static String STUDENT_NO_UNIQUE = "0";
    public final static String STUDENT_NO_NOT_UNIQUE = "1";
